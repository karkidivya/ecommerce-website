...
export const Products = ({products})=>{
  ...
  return <div className="py-10 cursor-pointer">
    ...
    <div className="max-w-screen-xl mx-auto py-10 grid px-8 items-stretch sm:px-4 xl:grid-cols-5 lg:grid-cols-4 md:grid-cols-3 sm:grid-cols-2 grid-cols-1  gap-10">
